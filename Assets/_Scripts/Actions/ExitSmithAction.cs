...
namespace Flawless.Actions
{
    ...
    [ActionType("exit_smith_action")]
    public class ExitSmithAction : ActionBase
    {
        // Used for reflection when deserializing a stored action.
        public ExitSmithAction()
            : base()
        {
        }
        ...
        public override IAccountStateDelta Execute(IActionContext context)
        {
            ...
            if (!playerState.SceneState.InEncounter || !(playerState.SceneState.GetEncounter(environmentState) is SmithEncounter))
            {
